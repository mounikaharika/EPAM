...
import java.util.*;
/**
 * Determine whether or not there is a cycle in the list
...
public class Cycle_Detection {
     ...
     */
    /**
     * Determining cycle using fast and slow pointers
     * @param head
     * @return true(if cycle exist) or false (if there is no cycle)
     */
